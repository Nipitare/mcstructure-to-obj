...
const stairs = {
    model(x, y, z, vert, states) {
        ...
        if (isUpsideDown == 1) {
            returnCode += 'o Cube' + createCubiod(x, y, z, 0, 1, 0.5, 1, 0, 1, vert)
            vert += 8
            y -= 0.5
        } else {
            returnCode += 'o Cube' + createCubiod(x, y, z, 0, 1, 0, 0.5, 0, 1, vert)
            vert += 8
        }   
        ...
        if (curve.curveType == 'outside') {
            if ((direction == 'north' && curve.curveDirection == 'east') || (direction == 'east' && curve.curveDirection == 'north')) {
                ...
                returnCode += createCubiod(x, y, z, 0.5, 1, 0.5, 1, 0.5, 1, vert)
                vert += 8 
            }
            ...
            if ((direction == 'north' && curve.curveDirection == 'west') || (direction == 'west' && curve.curveDirection == 'north')) {
                ...
                returnCode += createCubiod(x, y, z, 0, 0.5, 0.5, 1, 0.5, 1, vert)
                vert += 8
            }
            ...
            if ((direction == 'east' && curve.curveDirection == 'south') || (direction == 'south' && curve.curveDirection == 'east')) {
                ...
                returnCode += createCubiod(x, y, z, 0.5, 1, 0.5, 1, 0, 0.5, vert)
                vert += 8
            }
            ...
            if ((direction == 'south' && curve.curveDirection == 'west') || (direction == 'west' && curve.curveDirection == 'south')) {
                ...
                returnCode += createCubiod(x, y, z, 0, 0.5, 0.5, 1, 0, 0.5, vert)
                vert += 8
            }
        }
        ...
        returnCode += createCubiod(x, y, z, x1, x2, 0.5, 1, z1, z2, vert)
        vert += 8
